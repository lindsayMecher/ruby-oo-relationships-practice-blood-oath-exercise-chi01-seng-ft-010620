...
cult1 = Cult.new("CULT", "Chicago", 2020, "We are a dope AF cult", 18)
cult2 = Cult.new("CULT", "Miami", 2020, "We only wear Gucci...", 20)
cult3 = Cult.new("Bro cult", "Miami", 2020, "We only wear crocs...", 21)
follower1 = Follower.new("Lindsay", 28, "yolo")
follower2 = Follower.new("Brad", 50, "noooooope")
follower3 = Follower.new("Duede", 90, "mannnnn")
follower4 = Follower.new("guy", 17, "idk")
